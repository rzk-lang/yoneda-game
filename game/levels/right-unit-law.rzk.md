...
- text: 'Feed the right-unit triangle `comp-id-witness A x y f` to `uniqueness-comp-is-segal`, with `id-hom A y` as the second edge and `f` as the hypotenuse. Assemble the call yourself.'
  when-goal: '= f'
id: right-unit-law
inventory:
